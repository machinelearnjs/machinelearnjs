...
# DECLAIMER: This is an exact clone of release-it.sh but for pre-release purpose. I chose the clone approach to avoid unwanted regressions.
#            It is fine because this script will be short-lived
